...
"                           hi String guifg=#729fcf  " a string constant:
"                           "this is a string"
"                           hi Character guifg=#3465a4  " a character
"                           constant: 'c', '\n'
"                           hi Number guifg=#e9b96e  " a number constant: 234,
"                           0xff
"                           hi Boolean guifg=#c1c144  " a boolean constant:
"                           TRUE, false
"                           hi Float guifg=#c1c144  " a floating point
"                           constant: 2.3e10
"
"                           " ===== Identifier : any variable name
"                           hi Identifier   guifg=#f57900   " function name
"                           (also: methods for classes)
"
"                           " ===== Statements : Les mots cles de chaque
"                           language
"                           hi Statement    guifg=#729fcf " par défaut
"                           hi Conditional guifg=#4e9a06 " if, then, else,
"                           endif, switch, etc.
"                           hi Repeat guifg=#73d216 " boucles for, do, while,
"                           etc.
"                           hi Label guifg=#8ae234 " case, default, etc.
"                           hi Operator guifg=#fcaf3e  " "sizeof", "+", "*",
"                           etc.
...
"                           hi PreCondit guifg=#eeeeec  " preprocessor #if,
"                           #else, #endif, etc.
"
"                           " ==== Types : int, long, char, etc.
"                           hi Type     guifg=#ffffff   " int, long, char,
"                           etc.
"                           hi StorageClass guifg=#ffffff  " static, register,
"                           volatile, etc.
"                           hi Structure guifg=#ffffff  " struct, union, enum,
"                           etc.
"                           hi Typedef guifg=#ffffff  " A typedef
"                            
"                            " ==== Special : any special symbol
"                            hi Special guifg=#eeeeec " any special symbol
"                            hi SpecialChar guifg=#eeeeec  " special character
"                            in a constant
"                            hi Tag guifg=#eeeeec  " you can use CTRL-] on
"                            this
"                            hi Delimiter guifg=#eeeeec  " character that
"                            needs attention
"                            hi SpecialComment guifg=#eeeeec  " special things
"                            inside a comment
"                            hi Debug guifg=#eeeeec  " debugging statements
"
"                            " ==== Underlined : text that stands out, liens
"                            HTML
...
"                            "hi DiffText
"                            "hi ErrorMsg
"                            hi VertSplit   guibg=#888a85 guifg=#2e3436
"                            gui=none
...
"                            hi StatusLine  guibg=#888a85 guifg=#2e3436
"                            gui=none
"                            hi StatusLineNC    guibg=#888a85 guifg=#fce94f
"                            gui=none

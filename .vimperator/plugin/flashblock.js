              ...
              <constructor>
                <![CDATA[
                    ...
                    function Placeholder(embed) {
                        ...
                        document.flashblockStyle.insertRule("[flashblock='" + this.idx + "'] {}", 0);
                    ...
                    Placeholder.prototype = {
                        ...
                        hideEmbed: function() {
                            ...
                            ['width', 'height'].forEach(function(dimen) {
                                if (embed[dimen])
                                    if (/%$/.test(embed[dimen]))
                                        self.style[dimen] = embed[dimen];
                                    else
                                        self.style[dimen] = parseInt(embed[dimen]) + "px";
                            });
